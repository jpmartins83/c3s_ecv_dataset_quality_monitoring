...
MAP_STYLES = {
    ...
    # Net radiation diverges about zero; "berlin" is RdBu_r without the white
    # midpoint, which here would be indistinguishable from a missing cell.
    "SRB": dict(cmap="berlin", levels=np.arange(-150, 351, 25)),
